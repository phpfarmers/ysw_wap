	...
	<div class="append">
	  ...
	  <div class="app_con">
			...
			<div class="user_form_addgs">
					...
					<div class="user_form_line"><span class="add"><em>*</em>公司/团队的名字：</span><span><input name="company_name" type="text" value="" class="user_input" id="company_name" onkeyup="lookup(this.value);"/></span><div class="error"><?php echo form_error('company_name'); ?></div></div>
...
<script type="text/javascript">
//验证公司名称是否存在
function lookup(company_name)
{
	if(company_name.trim().length != 0)
	{ // 文本框输入内容为空时
		$.post('<?php echo site_url('user/check/check_company'); ?>' + '/' + company_name, function(data){
