	   ...
	   <!--left start-->
		<div class="coop_lf">
			<div class="new">
				 ...
				 <?php echo form_open_multipart('data/edit_upload/'.$data_detail['data_uuid']);?>
				 <div class="app_con" style="position:relative;">
						...
						<div class="user_form_line">
								...
								<span style=" text-align:left; font-size:14px; color:#999; line-height:55px; margin-top:8px; width:600px;"> <input type="file" name="userfile" size="20" /> </span>
						...
						<div class="user_form_line">
								...
								<span><input type="text" id="title" class="user_input zil_input" value="<?php echo $data_detail['title'];?>" name="title"/></span>
						</div>
						<div class="user_form_line">
							   ...
							   <span>
									<select name="category" id="category" class="user_select">
										...
										{
											if($row->id == $data_detail['category'] )
											{
						...
						<div class="user_form_line">
							   ...
							   <span>
									...
									{
										if($value == $data_detail['intergral'])
										{
						...
						<div class="user_form_line">
								...
								<span><textarea rows="7" cols="50" class="suggtext data_sug" name="content" id="content"><?php echo $data_detail['content'];?></textarea></span>
						</div>
						<div class="clear"></div>
						<div class="data_tj">
							   ...
							   <div style="margin-bottom:10px;">您还接受哪种反馈方式：
									 <?php $types = explode(',',$data_detail['feedback']);?>
									 <label><input type="checkbox" name="feedback[]" value="1" <?php if(in_array('1',$types)){echo 'checked="checked"';} ?>/> 邮箱沟通</label>
									 <label><input type="checkbox" name="feedback[]" value="2" <?php if(in_array('2',$types)){echo 'checked="checked"';} ?>/> 手机沟通</label>
									 <label><input type="checkbox" name="feedback[]" value="3" <?php if(in_array('3',$types)){echo 'checked="checked"';} ?>/> QQ沟通</label>
								</div>
								<div><label><input type="checkbox" id="agree" checked="checked"/> 我已经认真阅读并同意<strong>"游商网关于资料上传的《法律声明》"</strong>声明内容！ </label></div>
