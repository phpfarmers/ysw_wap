<div class="main">
        <div class="page1">
           <!--left start-->
            	  ...
            	  <div class="new">
                        <div class="new_nav">
						   <div class="new_nav_l">
							   ...
							   <span> > </span>
							   <span style="color:#333">所有投资</span> 
						   </div>
                           <div class="clear"></div>
                        </div>
                        <!--二nav start-->
                        <div class="er_nav">
                            <div class="er_xuan">
                                ...
                                <ul class="ft er_nav_ul">
									...
									?>
								    <li class="er_xuan_b"><a href="<?php echo site_url('invest');?>">重新筛选条件</a></li>
                                    <div class="clear"></div>
                                </ul>
                                <div class="clear"></div>
							</div>
            ...
            <!--right start-->
            <div class="coop_rt">
				<div class="release"><a href="<?php echo site_url('user/add_cooperation');?>" target="_blank"><span class="pub1_tu"></span><p class="rel_pp">我要发布</p></a></div>
