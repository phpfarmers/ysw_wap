<div class="main">
	<div class="page1 colist">
       <!--left start-->
    	<div class="colist_lf">
         	<h3><img src="<?php echo static_url('public/images/home.gif');?>"> <a href="<?php echo site_url();?>">首页</a> > <a href="<?php echo site_url('cooperation/index');?>">合作</a> > <span class="conlist_a"><?php echo $product->product_name;?></span></h3>
            <div class="conlist_xx">
                <dl>
                    <dt><img src="<?php if($product->product_icon){echo static_url('uploadfile/image/product/'.$product->product_icon);}else{echo static_url('public/images/dtu_1.jpg');}?>" width="180" height="180"> 
					 ...
					 <div class="colist_card">
						...
						?>
							<div class="coliat_card_span">
								<?php if($row->product_step != '0'):?>
								<span>游戏阶段：<?php echo $step[$row->product_step];?></span>
								<span style=" margin:0 0px 0 20px;">完成度：<?php echo $row->product_step_percent;?>%</span> 
								<?php else:?>
								<span >完成度：<?php echo $row->product_step_percent;?>%</span> 
								<?php endif;?>
								<span style="margin-left:20px;"><a class="conlist_a2 collection_task pointer" rel="<?php echo  $row->task_uuid;?>" link="<?php echo uri_string();?>"></a></span>
							</div>
							<div class="clear"></div>
							<div>合作指数：星星等级</div>
							<dl>
